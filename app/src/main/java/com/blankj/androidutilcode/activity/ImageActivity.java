...
public class ImageActivity extends BaseBackActivity {
    ...
    public void initView(Bundle savedInstanceState, View view) {
        ...
        ImageView ivRoundAddFrame = (ImageView) findViewById(R.id.iv_add_round_frame);
        ...
        ivRoundAddFrame.setImageBitmap(ImageUtils.addFrame(ImageUtils.toRound(src),8,Color.GREEN));
